...
class JIGEN_AlexNet(nn.Module):
    def __init__(self, n_classes=100, n_permutations=31, dropout=True):
        super(JIGEN_AlexNet, self).__init__()
        print("Using  JIGEN AlexNet")
        ...
        self.jigsaw_classifier = nn.Linear(4096, n_permutations)
...
def jigen_alexnet(classes, permutations):
    model = JIGEN_AlexNet(n_classes = classes, n_permutations = permutations+1)
