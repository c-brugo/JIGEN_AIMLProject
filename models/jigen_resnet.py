...
class JIGEN_ResNet(nn.Module):
    def __init__(self, block, layers, classes=100, permutations=31):
        self.inplanes = 64
        super(JIGEN_ResNet, self).__init__()
        ...
        self.jigsaw_classifier = nn.Linear(512 * block.expansion, permutations)
...
def jigen_resnet18(classes, permutations):
